...
const RegistrationHero: React.FC = () => {
  return (
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center  border border-4">
            ...
            {/* Right Section - Image */}
            <div className="w-full lg:w-1/2 lg:flex-shrink-0 flex justify-center lg:justify-end border overflow-hidden">
              <RegistrationImage />
            </div>
          </div>
